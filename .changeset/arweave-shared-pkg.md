---
'@toon-protocol/arweave': patch
'@toon-protocol/views': patch
'@toon-protocol/rig': patch
'@toon-protocol/client-mcp': patch
---

Extract the Arweave gateway preference list into a single shared package `@toon-protocol/arweave` (was hand-duplicated in `views`, `rig`, and `client-mcp`).
