// Drive a real paid publish through the compiled client at a REAL Rust
// connector's client edge. Not part of the suite — run by hand against a
// running connector:
//
//   EDGE=http://127.0.0.1:3000 DEST=g.local.app.write node scripts/live-sealed-publish.mjs
